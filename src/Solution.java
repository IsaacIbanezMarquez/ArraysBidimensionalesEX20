...
{
    // 11) Queremos realizar una encuesta a 10 personas, en esta encuesta indicaremos el sexo (1=masculino, 2=femenino),
    // si trabaja (1=si trabaja, 2= no trabaja) y su sueldo (si tiene un trabajo, sino sera un cero) estará entre 600 y
    // 2000 (valor entero). Los valores pueden ser generados aleatoriamente. Calcula y muestra lo siguiente:
    //
    ...
    //Usa todos los métodos que veas necesarios, piensa que es aquello que se repite o que puede ser mejor tenerlo
    // por separado.
